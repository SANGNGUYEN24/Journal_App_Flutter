          ...
          child: Column(
            children: <Widget>[
              ...
              TextField(
                ...
                // tell the keyboard action button to move to the next field
                focusNode: _moodFocus,
                textCapitalization: TextCapitalization.words,
                // every word is automaticall
                  ...
                  FlatButton(
                    ...
                    onPressed: (){
                      ...
                      String _id = widget.add? Random().nextInt(9999999).toString()
                          : _journalEdit.journal.id; // recommend use UUID in production evironment
